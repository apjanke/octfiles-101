...
_TODO: This section about creating NDArrays from doubles is wrong! The input conversions don't work the way I thought. They're actually getting converted to characters or something._
